...
class _HomPageState extends State<HomPage> {
  ...
  void initState() {
    ...
    currentIndex = 0;
    super.initState();
    item2 = GetData().filterSearch(byItem: tabBar[currentIndex].toString().toLowerCase());
  }
            ...
            Container(
              ...
              child: GridView.builder(
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 2),
                itemCount: 6,
                itemBuilder: (context, int index) => DetailPage(
                  types: item2[index],key: ValueKey(currentIndex),
                ),
              ),
            ),
          ],
